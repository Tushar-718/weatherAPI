...
const WeatherApp = () => {
  let api_key = "0248c5f12f0a5d7aeafb7612343949f9";
  // Here wicon is a variable where we initialise it with cloud_icon & setWicon is a func to update the data in wicon 
